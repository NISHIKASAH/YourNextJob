                    ...
                    plans.map((plan) => {
                        ...
                        return (
                            <motion.div
                                ...
                                ${isSelected ? "border-4 border-emerald-600 bg-emerald-50 shadow-lg" : "border border-gray-200 bg-white shadow-sm hover:shadow-md"}
                                ...
                                {/* {
                                    isSelected && (
                                        <motion.button
                                            ...
                                            className="mt-8 w-full bg-emerald-600 text-white py-3 rounded-lg shadow hover:bg-emerald-700 transition"
                                        >
                                            Proceed to Payment
                                        </motion.button>
                                    )
